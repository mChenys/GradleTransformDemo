 ...
 * https://www.jianshu.com/p/c6863aca4f2d
 */
class CysTransform extends Transform {

    private static Project project
    private static final String NAME = "CysAutoTrack"
    ...
    static void printCopyRight() {
        ...
        println("******************************************************************************")
        println("******                                                                  ******")
        println("******                欢迎使用 CysTransform 编译插件                      ******")
        println("******                                                                  ******")
        println("******************************************************************************")
        println()
    }

    CysTransform(Project project) {
        this.project = project
    }

    @Override
    String getName() {
        return NAME // Transform名称
    }
    ...
    Set<? super QualifiedContent.Scope> getScopes() {
        return TransformManager.SCOPE_FULL_PROJECT // 表示要处理所有的class字节码
    }

    @Override
    boolean isIncremental() {
        return false // 增量编译开关,不开启
    }
